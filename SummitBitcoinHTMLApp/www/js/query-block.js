document.getElementById('getinfo').onclick = function () {
  ...
  $fh.cloud(
      ...
      function (res) {
        ...
        document.getElementById('cloudResponse_name').innerHTML = "Name: " + res.data.name;
        document.getElementById('cloudResponse_height').innerHTML = "Height: " + res.data.height;
        document.getElementById('cloudResponse_hash').innerHTML = "Hash: " + res.data.hash;
      },
